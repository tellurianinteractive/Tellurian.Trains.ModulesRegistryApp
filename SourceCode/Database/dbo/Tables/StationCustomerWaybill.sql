...
(
    ...
    [IsManuallyCreated]         BIT CONSTRAINT [DF_StationCustomerWaybill_IsManuallyCreated] DEFAULT ((0)) NOT NULL,
    [HasEmptyReturn]            BIT CONSTRAINT [DF_StationCustomerWaybill_HasEmptyReturn] DEFAULT ((0)) NOT NULL,
    [IsExpressCargo]            BIT CONSTRAINT [DF_StationCustomerWaybill_IsExpressCargo] DEFAULT ((0)) NOT NULL,
    [IsCoolingTransport]        BIT CONSTRAINT [DF_StationCustomerWaybill_IsCoolingTransport] DEFAULT ((0)) NOT NULL,
    [HideLoadingTimes]          BIT CONSTRAINT [DF_StationCustomerWaybill_HideLoadingTimes] DEFAULT ((0)) NOT NULL,
    [HideUnloadingTimes]        BIT CONSTRAINT [DF_StationCustomerWaybill_HideUnloadingTimes] DEFAULT ((0)) NOT NULL,
