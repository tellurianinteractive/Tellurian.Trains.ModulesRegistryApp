...
(
    ...
    [PhoneNumber]					NVARCHAR(6) NULL,
    [PhoneNote]						NVARCHAR(50) NULL,
    [HideMeetingTrains]				BIT DEFAULT ((0)) NOT NULL,
    [HidePassingTrains]				BIT DEFAULT ((0)) NOT NULL,
    [PrintTrainStartLabels]			BIT DEFAULT ((0)) NOT NULL,
    [PrintOnlyFirstTrainStartLabel] BIT DEFAULT ((0)) NOT NULL,
