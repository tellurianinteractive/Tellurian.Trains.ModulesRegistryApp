...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      Begin Tables = 
         Begin Table = "ExternalStation"
            ...
            TopColumn = 0
         End
         Begin Table = "ExternalStationCustomer"
            Begin Extent = 
               Top = 44
               Left = 50
               Bottom = 207
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'ListExternalStationCustomer';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'ListExternalStationCustomer';
