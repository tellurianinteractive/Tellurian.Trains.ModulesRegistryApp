...
public class VehicleValidator : AbstractValidator<Vehicle>
{
    public VehicleValidator(IStringLocalizer<App> localizer)
    {
        ...
        RuleFor(x => x.F0).Length(0, 10);
        RuleFor(x => x.F1).Length(0, 10);
        RuleFor(x => x.F2).Length(0, 10);
        RuleFor(x => x.F3).Length(0, 10);
        RuleFor(x => x.F4).Length(0, 10);
        RuleFor(x => x.F5).Length(0, 10);
        RuleFor(x => x.F6).Length(0, 10);
        RuleFor(x => x.F7).Length(0, 10);
        RuleFor(x => x.F8).Length(0, 10);
        RuleFor(x => x.F9).Length(0, 10);
        RuleFor(x => x.F10).Length(0, 10);
        RuleFor(x => x.F11).Length(0, 10);
        RuleFor(x => x.F12).Length(0, 10);
        RuleFor(x => x.F13).Length(0, 10);
        RuleFor(x => x.F14).Length(0, 10);
        RuleFor(x => x.F15).Length(0, 10);
        RuleFor(x => x.F16).Length(0, 10);
        RuleFor(x => x.F17).Length(0, 10);
        RuleFor(x => x.F18).Length(0, 10);
        RuleFor(x => x.F19).Length(0, 10);
        RuleFor(x => x.F20).Length(0, 10);
        RuleFor(x => x.F21).Length(0, 10);
        RuleFor(x => x.F22).Length(0, 10);
        RuleFor(x => x.F23).Length(0, 10);
        RuleFor(x => x.F24).Length(0, 10);
        RuleFor(x => x.F25).Length(0, 10);
        RuleFor(x => x.F26).Length(0, 10);
        RuleFor(x => x.F27).Length(0, 10);
        RuleFor(x => x.F28).Length(0, 10);
        RuleFor(x => x.F29).Length(0, 10);
