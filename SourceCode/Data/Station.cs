...
public static class StationExtensions
{
    ...
    public static bool HasPassengerTraffic(this Station? me) => me is not null && (me.IsShadow || me.StationTracks.Any(t =>  t.PlatformLength.HasValue && t.PlatformLength.Value > 0));
