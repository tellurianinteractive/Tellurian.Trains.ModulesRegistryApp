...
- **Passenger tickes** now prints in the language of the selling station, e.g. the start station of the return ticket.
## Release 1.12.15
...
- **Mailing** individual meeting or layout participants by clicking the email icon in the lists. Only available for meeting- and layout administrators.
- **Mailing server** changed to [Brevo](https://brevo.com) due to SendGrid has no longer a free plan and to improve fewer mails ends up in the recipient's spam folder. NOTE: This only affects *password reset* and *invitation* e-mails. 
...
- **Layout modules** per participant can now be added or edited in the layout participant list.
- **Meeting participant** list now contains registration time.
- **Participation duration** now uses abbreviated day names to save space.
## Release 1.12.11
Release date 2025-07-05
- **Upload size** for DWG-drawings and PDF-documents increased to 500 kB. SKP-drawings limited to 500kB. Note that upload of SKP-files requires special permission.
...
- **Bug fix** of check of ownership to delete module.
- **Not authorised page** updated with overview over administrative rights to explanin resons for not having access to a page.
## Release 1.12.7
...
- **Bug fix** of administrators not able to change meeting data.
## Release 1.11.7
